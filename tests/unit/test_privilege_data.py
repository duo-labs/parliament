...
class TestPrivilegData(unittest.TestCase):
    ...
    def test_minimum_number_of_services(self):
        assert_true(len(parliament.iam_definition)>220, "There should be over 220 services in the definition file")
    ...
    def test_contains_all_elements(self):
        ...
        assert_true(len(ec2_service['resources']) > 30, "There should be over 30 resources in the EC2 service")
        ...
        assert_true('vpc' in vpc_resource['arn'], "The arn for the vpc resource should contain the string 'vpc'")
        assert_true(len(vpc_resource['condition_keys']) >= 5, "There should be at least 5 condition_keys in the vpc resource")
